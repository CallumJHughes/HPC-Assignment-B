program main
	...
	real(kind=dp) :: lOuter, lInner, rOuter, rInner, avgBefore, avgAfter, systemSumBefore, systemSumAfter, start, finish
	...
	sysHeight = int(lOuter)*20 ! Height of grid of data points
	sysWidth = int(rOuter)*20 ! Width of grid of data points
	...
	time_loop: do t = 1, 100000
		...
		!******************************!
		do i = 1, sysHeight
			do k = 2 + (rank*(sysWidth/num_procs)), ((sysWidth/num_procs)*(rank+1))-1	!2, (sysWidth/num_procs)-1
	...
	print *, "Processor", rank, "took", finish-start, "seconds"
	...
	if (rank == 0) print *, "Point A:", system(150,1)
